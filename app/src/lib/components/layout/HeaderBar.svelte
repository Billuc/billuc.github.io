...
<div class="group fixed top-4 left-1/2 -translate-x-1/2 w-5/6 z-10">
	<div
		class="
            flex flex-row flex-wrap w-fit
			bg-zinc-900 dark:bg-teal-600
			text-teal-50 rounded-full
			shadow-xl px-4 mx-auto
        "
	>
